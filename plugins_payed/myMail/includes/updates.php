...
global $pagenow, $mymail_options;

$new_version = MYMAIL_VERSION;

$texts = $mymail_options['text'];
...
if($old_version == '2.1.1.1'){
	mymail_notice('pagenow:'. $pagenow);
	mymail_notice('auto:'. $is_auto_update);
}

if($old_version && $pagenow == 'wp-cron.php')
	mymail_notice(array(
		'key' => 'update_info',
